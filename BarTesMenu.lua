-- BaraLeaks FIX WINDOW VERSION (Half Screen)
...
-- WINDOW (SETENGAH LAYAR)
local window = new("Frame", {
    Parent = screenGui,
    Name = "Window",
    Size = UDim2.new(0.5,0,0.45,0), -- SETENGAH LAYAR
    Position = UDim2.new(0.5,-(0.5*300),0.4,0),
